...
class AddRecipientsViewModel: NSObject {
    ...
    func loadPeople() {
        ...
        friends.append(Person(firstName: "Mike", lastName: "Todasco", userName: "mikeTodasco", profileImageName: "user_mikeyT"))
      
        topPeople.append(Person(firstName: "Mike", lastName: "Todasco", userName: "mikeTodasco", profileImageName: "user_mikeyT"))
